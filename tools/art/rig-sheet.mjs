 ...
 * same as `art:rigs`, and Pillow, the same as the other art tooling.
 */
...
/** Same resolution rule as build-rigs.mjs — the tool is not a repo dependency. */
function resolveCli() {
...
try {
  ...
  if (rows.length === 0) {
    console.error("error: no rigs to sheet — run `npm run art:rigs` first");
    process.exit(1);
  }

...
function main(): void {
  ...
  // The mechanical half of a creature page. Generated by `npm run canon:bestiary`;
  // absent is fine and simply omits the section.
  const readJson = (rel: string): Record<string, never> | null => {

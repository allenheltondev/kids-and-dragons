...
related:
  ...
  - id: location.bone_yard
    ...
    relationship: locations
ai_context:
  mood: "The wide water surrounding the realm, reached from every coast and owned by none of them."
...
- [Sky Islands](/biomes/sky_islands/) `Locations`
- [The Sallow Wastelands](/biomes/sallow_wastelands/) `Locations` `Borders`
...
### Npcs
- [Merfolk](/npcs/merfolk/) `Supporting Peoples`
- [Selkie](/npcs/selkie/) `Supporting Peoples`

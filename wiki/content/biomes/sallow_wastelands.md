...
tags: ["coastal_lowland", "brackish", "mudflats", "saltrot", "unstable_ground"]
danger_level: high
regional_relationships:
  - id: feature.great_river
    title: "The Great River"
    url: "/features/great_river/"
    relationship: "The employer. The Glacierflow delivers, the flats receive, and the arrangement has run without a contract since the north was first cold."
  - id: location.bone_yard
    title: "The Bone Yard"
    url: "/locations/bone_yard/"
    relationship: "The flats hold the only landward approach, and hold it loosely: reaching the Yard is meant to take effort, and the Saltrot provides the effort."
...
related:
  ...
  - id: location.bone_yard
    ...
    relationship: biome
ai_context:
  mood: "The humid, brackish coastal lowland where the Glacierflow loses its strength before the sea - mudflats, shallow shifting channels, stunted vegetation, and ground that cannot be trusted twice. Travelers commonly call the region the Saltrot."
...
To the realm, the Saltrot is the cautionary approach to the Bone Yard and the price of reaching it; to the guides it is a working landscape with a schedule; to the river it is the end of a very long errand.
...
- Some say the flats rearrange themselves to steer travelers away from the Bone Yard. The guides say floods are floods, and say it in the tone of people who have been asked before.
...
- A named flood two generations back delivered a sealed cabin door, frame and all, standing upright in the flats. It has never been opened, on the guides' advice, and the advice has never been explained.
- Somewhere under the silt is the bridge the flood brought. Every guide knows roughly where. No guide will take you.
<!-- END GENERATED: lore -->
...
- [The Open Sea](/biomes/open_sea/) `Locations` `Borders`

### Creatures
- [Bone Crawler](/creatures/bone_crawler/) `Dangerous Creatures`
- [Restless Remains](/creatures/restless_remains/) `Supernatural Manifestations`

### Features
- [The Great River](/features/great_river/) `Locations`

### Locations
- [The Bone Yard](/locations/bone_yard/) `Locations` `Contains Sites` `Biome`

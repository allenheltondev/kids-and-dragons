...
DESTINATIONS = {
    "red_sky_foothills": {
        "background": "biome_red_sky_foothills_bg_raw.png",
        "props": "red_sky_foothills_props_alpha.png",
        "prop_names": (
            "cave_arch",
            "crystal_boulder",
            "volcanic_scrub",
    ...
    "mount_red_sky": {
        "background": "biome_mount_red_sky_bg_raw.png",
        "props": "mount_red_sky_props_alpha.png",
        "prop_names": (
            "basalt_spire",
            "lava_pool",
            "ember_boulder",
...
def package_tiles() -> Image.Image:
    source = Image.open(SOURCE / "red_sky_volcanic_tiles_raw.png").convert("RGB")
...
background_review.save(REVIEW / "red_sky_volcanic_backdrops.png", optimize=True)

shared_tiles.save(REVIEW / "red_sky_volcanic_tiles.png", optimize=True)
...
props_review.save(REVIEW / "red_sky_volcanic_props.png", optimize=True)

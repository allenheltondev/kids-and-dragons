...
DESTINATIONS = {
    "enchanted_woods": {
        "background": "biome_enchanted_woods_bg_raw.png",
        "props": "enchanted_woods_props_alpha.png",
        "prop_names": (
            "seed_pod_roots",
            "moss_boulder",
            "fern_cluster",
    ...
    "mosshome": {
        "background": "biome_mosshome_bg_raw.png",
        "props": "mosshome_props_alpha.png",
        "prop_names": (
            "lantern_post",
            "stair_platform",
            "rope_walkway",
...
def package_tiles() -> Image.Image:
    source = Image.open(SOURCE / "enchanted_forest_tiles_raw.png").convert("RGB")
...
background_review.save(REVIEW / "enchanted_forest_backdrops.png", optimize=True)

shared_tiles.save(REVIEW / "enchanted_forest_tiles.png", optimize=True)
...
props_review.save(REVIEW / "enchanted_forest_props.png", optimize=True)

...
SOURCE = ROOT / "art" / "source" / "impact_strike_storyboard_raw.png"
...
strip.save(EFFECTS / "impact_strike.sheet.png", optimize=True)

(EFFECTS / "impact_strike.json").write_text(
...
review.save(REVIEW / "impact_strike_frames.png", optimize=True)

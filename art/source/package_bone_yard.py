...
PROP_NAMES = (
    "fossil_rib_arch",
    "vertebra_stack",
    "ancient_fossil_skull",
    "driftwood_root_jam",
    "spiral_fossil_boulder",
    "delta_debris_bar",
)
...
column_edges = (
    (
        0,
        round(prop_source.width * 0.350),
        round(prop_source.width * 0.642),
        prop_source.width,
    ),
    (
        0,
        round(prop_source.width * 0.339),
        round(prop_source.width * 0.638),
        prop_source.width,
    ),
)
...
label_centered(background_review, "THE BONE YARD", 550, 480)
background_review.save(REVIEW / "bone_yard_backdrop.png", optimize=True)

tile_sheet.save(REVIEW / "bone_yard_tiles.png", optimize=True)
...
label_centered(props_review, "THE BONE YARD", 350, 256)
props_review.save(REVIEW / "bone_yard_props.png", optimize=True)

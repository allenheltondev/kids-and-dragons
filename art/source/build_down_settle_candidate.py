...
SOURCE_DIR = ROOT / "art" / "source" / "down_settle_candidate"
...
def main() -> None:
    ...
    build_review(frames, REVIEW_DIR / "down_settle_candidate.png")
    build_gif(frames, REVIEW_DIR / "down_settle_candidate.gif")

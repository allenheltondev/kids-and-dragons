...
DESTINATION = "stone_crossing"
BACKGROUND = "biome_stone_crossing_bg_raw.png"
TILES = "great_river_tiles_raw.png"
PROPS = "stone_crossing_props_alpha.png"
PROP_NAMES = (
    "carved_bridge_parapet",
    "crossing_bell_markers",
    "mossy_gorge_boulders",
    "driftwood_root_jam",
    "bridge_repair_hoist",
    "current_warning_mast",
)
...
background_review = Image.new("RGB", (960, 590), (18, 21, 26))
background_review.paste(
    background.resize((960, 540), Image.Resampling.LANCZOS),
    (0, 0),
)
label_centered(background_review, "STONE CROSSING", 550, 480)
background_review.save(REVIEW / "stone_crossing_backdrop.png", optimize=True)

tile_sheet.save(REVIEW / "stone_crossing_tiles.png", optimize=True)

props_review = Image.new("RGB", (512, 390), (18, 21, 26))
for prop_index, prop in enumerate(packaged_props):
    row, col = divmod(prop_index, 3)
    cell = Image.new("RGB", (160, 160), (38, 44, 51))
...
label_centered(props_review, "STONE CROSSING", 350, 256)
props_review.save(REVIEW / "stone_crossing_props.png", optimize=True)

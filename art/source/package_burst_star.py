...
SOURCE = ROOT / "art" / "source" / "burst_star_storyboard_raw.png"
...
strip.save(EFFECTS / "burst_star.sheet.png", optimize=True)

(EFFECTS / "burst_star.json").write_text(
...
review.save(REVIEW / "burst_star_frames.png", optimize=True)

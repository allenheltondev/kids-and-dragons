...
def review_board(assembled: Image.Image) -> None:
    ...
    draw.text((50, 34), "Duskrunner Sworn Kitsune - rig split", font=title, fill="white")
    draw.text(
        (52, 88),
        "Approved exact pose   -   hood and scarf follow the head and chest   -   three tails remain clear",
        font=note,
        fill="#b9c7d8",
    )
    panels = [

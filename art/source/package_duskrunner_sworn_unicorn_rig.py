#!/usr/bin/env python3
"""Build the Duskrunner Sworn Unicorn exact-pose class-rig art package."""
...
CANVAS = (1024, 1024)
SOURCE = ROOT / "assets/gear-portraits/duskrunner/sworn/unicorn.png"
...
def register_subject(
    portrait: Image.Image, alpha: Image.Image
) -> tuple[Image.Image, Image.Image]:
    """Scale and place the approved pose onto the Sworn Unicorn rig canvas."""
...
def main() -> None:
    ...
    # The opaque portrait includes a soft painted ground shadow. Nothing below
    # the fetlocks is class gear, so use the canonical hoof silhouettes there.

...
SOURCE_DIR = ROOT / "art" / "source" / "miss_veer_candidate"
...
def main() -> None:
    ...
    build_review(frames, REVIEW_DIR / "miss_veer_candidate.png")
    build_gif(frames, REVIEW_DIR / "miss_veer_candidate.gif")
